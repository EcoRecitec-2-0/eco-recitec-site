...
var validator = {
        vTypes: ["not_zero", "not_null", "not_null_no_trim", "percent", "decimal_2", "decimal_3", "email", "fone", "cep", "linkedin", "date", "time", "regex", "cnpj", "cpf", "min_value", "max_value"],
        warnings: {
            ...
            linkedin: "O valor do campo {0} é inválido.",
